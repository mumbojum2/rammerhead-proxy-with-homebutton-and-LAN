...
## lan help 
everything works only thing you have to configure is go into src/config.js and change this line `hostname: '192.168.1.105', // your LAN IP` to your actual lan ip from cmd by putting this command in cmd `ipconfig | findstr /i "ipv4"` pressing enter and changing the ip address to what it says
