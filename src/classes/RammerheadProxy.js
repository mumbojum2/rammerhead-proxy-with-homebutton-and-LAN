...
class RammerheadProxy extends Proxy {
    ...
    constructor({
        ...
        if (!crossDomainPort) {
            ...
            proxyHttpOrHttps.createServer = function (...args) {
                const emptyFunc = () => {};
                if (onlyOneHttpServer) return { on: emptyFunc, listen: emptyFunc, close: emptyFunc };
        ...
        // <<< INITIALIZE PIPELINES BEFORE SETUP
        ...
        // <<< CALL SERVICE ROUTES AFTER INITIALIZATION
     ...
     */
        ...
        // Add your home button script route
        this.GET('/inject-home-btn.js', {
            content: `(function() {
    ...
    function addBtn() {
        ...
        btn.style.cssText = 'position:fixed;top:10px;right:10px;z-index:9999;padding:10px 15px;background:#28a745;color:white;border:none;border-radius:5px;cursor:pointer;font-size:16px;box-shadow:0 2px 6px rgba(0,0,0,0.3);';
